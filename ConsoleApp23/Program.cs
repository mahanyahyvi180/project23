...
namespace ConsoleApp23
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Before adding to item:" + $"Count={items.Count}; Capacity={items.Capacity}");
            ...
            Console.WriteLine("After adding two elements to item : " + $"Count ={items.Count}; Capacity={items.Capacity}");
